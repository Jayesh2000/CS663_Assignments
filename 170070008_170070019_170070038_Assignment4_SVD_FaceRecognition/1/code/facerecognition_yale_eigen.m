function [] = facerecognition_yale_eigen()
...
U = U(:,end-1:-1:1520-k_vector(k)); % Top k eigen_vectors are extracted and stored in U
...
ylabel('Recognition rate');
 title('Eigen Decomposition on Yale database');
end