function [] = myminifacerecognition_eigen()
...
U = U(:,end-1:-1:192-k_vector(k)); % Top k eigen_vectors are extracted and stored in U
...
title('Eigen Decomposition on ORL database');
